            ...
            <div className="col-12 col-lg-8">
              ...
              <div className={state.userType === 4 ? '' : 'hide'}>
                ...
                <p className="form-text link">
                  <a href="https:// /docs/admin/trigger/sendnotification#%E8%8E%B7%E5%8F%96%E4%BC%81%E4%B8%9A%E5%BE%AE%E4%BF%A1%E7%BE%A4%20Webhook%20%E5%9C%B0%E5%9D%80" target="_blank">
                    {$L('如何获取群 Webhook 地址')}
                  </a>
                </p>
              </div>
              <div className={state.userType === 5 ? '' : 'hide'}>
                ...
                <p className="form-text link">
                  <a href="https:// /docs/admin/trigger/sendnotification#%E8%8E%B7%E5%8F%96%E9%92%89%E9%92%89%E7%BE%A4%E5%8F%B7" target="_blank">
                    {$L('如何获取群号')}
                  </a>
                </p>
              </div>
