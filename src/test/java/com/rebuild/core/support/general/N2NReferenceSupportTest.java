...
class N2NReferenceSupportTest extends TestSupport {
    ...
    void getN2NValueByMixPath() {
        Object[] F_N2N = N2NReferenceSupport.getN2NValueByMixPath("zuijindingdan.kehunn",
                ID.valueOf("982-01870e95356e0036"));
        System.out.println(Arrays.toString(F_N2N));

        Object[] F_N2N_F = N2NReferenceSupport.getN2NValueByMixPath("zuijindingdan.kehunn.AccountName",
                ID.valueOf("982-01870e95356e0036"));
        ...
        Object[] N2N_F = N2NReferenceSupport.getN2NValueByMixPath("kehunn.AccountName",
                ID.valueOf("985-018316f0c6b60068"));
